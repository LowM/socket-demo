...
public class myClientSocketChannel {
     ...
     * @throws IOException
     */
    public myClientSocketChannel(String HostIp,int HostListenningPort)throws IOException {
        this.hostIp=HostIp;
    ...
    public static void main(String[] args) throws IOException{
        myClientSocketChannel client=new myClientSocketChannel("localhost",4444);
